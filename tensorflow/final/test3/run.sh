...
echo "8";
python neural_luis.py $layers $epoca2 64 mean_squared_logarithmic_error elu sgd 0 4 0 > result/saida08.txt 2>&1;
echo "9";
python neural_luis.py $layers $epoca2 32 mean_squared_logarithmic_error elu sgd 0 4 0 > result/saida09.txt 2>&1;
# echo "10";
